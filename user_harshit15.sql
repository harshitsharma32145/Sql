...
--------------------------------------------------------------------------------------------------
----------------------department table----------------------------------------------------
create table department_harshit16
(
...
insert into department_harshit16 values(101,'ms')

insert into department_harshit16 values(102,'non-ms')

insert into department_harshit16 values(103,'ms')

insert into department_harshit16 values(1014,'ms')

insert into department_harshit16 values(105,'non-ms')

insert into department_harshit16 values(106,'non-ms')

insert into department_harshit16 values(107,'ms')

insert into department_harshit16 values(108,'ms')

insert into department_harshit16 values(109,'non-ms')

insert into department_harshit16 values(110,'ms')

insert into department_harshit16 values(111,'ms')

select * from department_harshit16
---------------------------------------------------------------------------------------
...
insert into equipment_harshit15 values('111','mobile','880','realme','14000')

insert into equipment_harshit15 values('112','watch','800','titan','900000')

insert into equipment_harshit15 values('113','mobile','230','samsung','50000')
--------------------------------------------------------------------
----------------------------------------update----------------------------
...
select  em.employee_name,dt.department, count(eq.Equipment_name) as totalequipment from equipment_harshit15 eq
inner join employee_harshit15 em
on em.employee_id=eq.Equipment_id
inner join department_harshit16 dt
on eq.Equipment_id=dt.department_id
group by em.employee_name ,dt.department
